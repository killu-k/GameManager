...
ALTER TABLE competition_score
    ADD CONSTRAINT competition_score_competition
...
ALTER TABLE competition_score
    ADD CONSTRAINT competition_score_team
        FOREIGN KEY (team_id)
            REFERENCES team (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE game_in_competition
    ADD CONSTRAINT game_in_competition_competition
        FOREIGN KEY (competition_id)
            REFERENCES competition (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE game_in_competition
    ADD CONSTRAINT game_in_competition_game
        FOREIGN KEY (game_id)
            REFERENCES game (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE team_in_game
    ADD CONSTRAINT team_in_game_game
        FOREIGN KEY (game_id)
            REFERENCES game (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE team_in_game
    ADD CONSTRAINT team_in_game_team
        FOREIGN KEY (team_id)
            REFERENCES team (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE team_player
    ADD CONSTRAINT team_player_team
        FOREIGN KEY (team_id)
            REFERENCES team (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE score
    ADD CONSTRAINT timed_score_team
        FOREIGN KEY (team_id)
            REFERENCES team (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE tournament_group
    ADD CONSTRAINT tournament_group_game
        FOREIGN KEY (game_id)
            REFERENCES game (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE tournament_group
    ADD CONSTRAINT tournament_group_team
...
ALTER TABLE tournament_result
    ADD CONSTRAINT tournament_result_team
        FOREIGN KEY (team_id)
            REFERENCES team (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE tournament_round_score
    ADD CONSTRAINT tournament_round_score_tournament_group
...
ALTER TABLE tournament_setup
    ADD CONSTRAINT tournament_setup_game
        FOREIGN KEY (game_id)
            REFERENCES game (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE user_in_game
    ADD CONSTRAINT user_in_game_game
        FOREIGN KEY (game_id)
            REFERENCES game (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE user_in_game
    ADD CONSTRAINT user_in_game_user
        FOREIGN KEY (user_id)
            REFERENCES "user" (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE "user"
    ADD CONSTRAINT user_user_detail
